...
- Offline retrieval helper: "latest row per entity"
...
## Quickstart (Docker: Postgres + Redis + API)

```bash
docker compose up --build
```

Seed demo data into **offline store** (Postgres in docker-compose):
